  ...
  <div class="container-fluid">
    <div class="main-twoform__content">
      <div class="main-twoform__item">
        <div class="main-footer__titleposition">
      ...
      <div class="main-twoform__item">
        <form method="POST" action="https://nivel.activehosted.com/proc.php" id="_form_35_" class="_form _form_35 _inline-form  _dark" novalidate>
          ...
          <div class="_form-content">
            ...
            <div class="main-contact__btnbox">
              <button id="_form_35_submit" class="btn_custom btn--medium btn--filledLight" type="submit">
                Enviar
              </button>
            </div>
