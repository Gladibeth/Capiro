        ...
        <div class="mask mask-light">
          <div class="main-banner__text">
            ...
            <div class="main-banner__dates main-banner__dates--two">
              <span>Área</span>
              <strong>Desde 112 m² hasta 313 m² </strong>
            </div> 
            <div class="main-banner__dates">
              <span>Desde <strong> $216 millones</strong>
              </span>
  ...
  <div class="container-fluid">
    <div class="main-oneform__content">
      ...
      <div class="main-oneform__item">
        ...
        <form method="POST" action="https://nivel.activehosted.com/proc.php" id="_form_33_" class="_form _form_33 _inline-form  _dark" novalidate>
          ...
          <div class="_form-content _form-content--grid">
            ...
            <div class="_form-content__item">
              ...
              <div class="btn-formone__content">
                <button id="_form_33_submit" class="btn_custom btn--small btn--filled" type="submit">
                  Enviar
                </button>
              </div>
            </div>
